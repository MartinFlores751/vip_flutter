                  ...
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        ...
                        _nick.text = "";
                        Fluttertoast.showToast(msg: 'Nickname set!',toastLength: Toast.LENGTH_SHORT);
                      }
                    ),
                  ],
                  contentPadding: const EdgeInsets.fromLTRB(25.0, 12.0, 25.0, 25.0));
                  ...
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        ...
                        else Fluttertoast.showToast(msg: "Emails don't Match!",toastLength: Toast.LENGTH_SHORT);
                      }
                    ),
                  ],
                  contentPadding: const EdgeInsets.fromLTRB(25.0, 12.0, 25.0, 25.0));
            ...
            SwitchListTile(
              ...
              onChanged: (bool newValue) {
                ...
                SimpleDialog dialog = SimpleDialog(
                  ...
                  children: [Text("By hitting the switch 'on' you have consented to occasional" + 
